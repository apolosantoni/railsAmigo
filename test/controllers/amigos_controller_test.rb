...
class AmigosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amigo" do
    assert_difference('Amigo.count') do
      post amigos_url, params: { amigo: { email: @amigo.email, nome: @amigo.nome, sobrenome: @amigo.sobrenome, telefone: @amigo.telefone, twitter: @amigo.twitter } }
    end
  ...
  test "should update amigo" do
    patch amigo_url(@amigo), params: { amigo: { email: @amigo.email, nome: @amigo.nome, sobrenome: @amigo.sobrenome, telefone: @amigo.telefone, twitter: @amigo.twitter } }
